      ...
      <div className={`${darkMode} card card-aboutme mb-5 d-sm-none aboutme-sm ${isDark ? 'bg-dark text-light border border-3 border-dark' : ''}`}>
        ...
        <div className="row g-0">
          ...
          <div className="content-fluid btn-group p-3 pt-1" role="group" aria-label="Basic example">
            <a href='https://www.linkedin.com/in/edu-gamboa/' target="_blank" rel="noreferrer" type="button" className={`btn border ${isDark ? 'btn-dark border-secondary border-1' : 'btn-outline-light border-2'} pt-0 pb-0 fs-4 border-end-0`} onClick={(ev) => handleClick(ev, false)}><i className="fa-brands fa-linkedin"></i></a>
